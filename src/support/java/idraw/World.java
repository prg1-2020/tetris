...
/**
 * to represent worlds of games (imperative version)
 * 
 */
public abstract class World implements KeyListener {
   ...
   */
  public void bigBang(int width, int height, final double s) {
    if (width <= 0)
   ...
   * @return this world
   */
  public void endOfWorld(final String s) {
    this.ended = true;
    this.message = s;
    return ;
  }
   ...
   * @return the world with new state
   */
  public void onClick(Posn location) {
    return ;
  }
  ...
  private void mouseClicked(MouseEvent e) {
    ...
    this.world.onClick(new Posn(worldX, worldY));
    this.world.theCanvas = this.theCanvas;
    this.world.draw();
  }
  @Override
  ...
  public void keyPressed(KeyEvent e) {
    this.world.onKeyEvent(keyEventName(e));
    this.world.theCanvas = this.theCanvas;
    this.world.draw();
  }
